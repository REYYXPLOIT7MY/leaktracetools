...
if os.name == "nt":
    os.system("cls")
    os.system("title RisszxxLeakTrace-Tools")
if os.name == "posix":
    os.system("clear")
...
def version_check():
    ...
    :return: version
    """
    path = "leaktracetools/version.txt"
    try:
...
def print_banner():
    """
    Prints the banner of RisszxxLeakTrace-Tools.
    """
    print(Fore.CYAN + f"""
    //    / /        \\ / /      /__  ___/ //   ) ) //   ) ) / /        //   ) )
   //___ / //___/ /   \  /         / /    //   / / //   / / / /        ((
 ...
 //    / /    / /    / /\\       / /    //   / / //   / / / /              ) )
//    / /    / /    / /  \\     / /    ((___/ / ((___/ / / /____/ / ((___ / /  
v{version} ~~by Risszxx (https://myth.rip)
    """)
...
def about():
    ...
    """
    print(Fore.GREEN)
    printer.nonprefix(f"LeakTrace-Tools, toolkit for scraping, OSINT and more.\n")
    printer.nonprefix(f"Completely open source and free to use! Feel free to contribute.\n")
    printer.nonprefix(f"Repo: https://github.com/ReyyXploit\n")
...
Or support me on GitHub: https://github.com/sponsors/ReyyXploit
...
def print_menu():
    """
    Prints the main menu of RisszxxLeakTrace-Tools.
    """
...
def handle_exit():
    ...
    printer.info("Thanks for using RisszxxLeakTrace-Tools! Remember to star this on GitHub! \n -Risszxx")
    time.sleep(1)
    print(Fore.RESET)
    exit()
...
def main():
    ...
    if version_from_url is None:
        ...
        printer.warning("Check for updates..! (https://github.com/ReyyXploit)")
        time.sleep(3)
